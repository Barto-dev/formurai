(() => {
        ...
        return (values, params, outputArr) => {
          ...
          for (const value of values) {
            ...
            if (result) {
              ...
              hasErrors = true;
              errors2.push(validator2.getErrors().field);
              results.push(null);
            }
          }
          if (hasErrors) {
        ...
        return (objects, params, outputArr) => {
          ...
          for (const object of objects) {
            ...
            if (result) {
              ...
              hasErrors = true;
              errors2.push(validator2.getErrors());
              results.push(null);
            }
          }
          if (hasErrors) {
  ...
  var allSectionSteps = document.querySelectorAll(".form-step");
  var submitButton = document.querySelector("#multistep-form .submit");
  var MAX_STEP = 3;
  function changeCurrentStep(btn) {
